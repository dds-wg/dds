...
Source: lexicons/org/dds-wg/v1/decision.json
...
class Main(BaseModel):
    """Generated from org.dds-wg.v1.decision#Main."""
    model_config = ConfigDict(populate_by_name=True, extra="allow")
    type_: str = Field("org.dds-wg.v1.decision", alias="$type")
    schemaVersion: Optional[str] = None
    name: str
    summary: str
    creator: Union[_v1_defs.UserAgent, _v1_defs.AlgorithmAgent]
    acceptedProposals: Optional[list[_repo_strong_ref.Main]] = None
