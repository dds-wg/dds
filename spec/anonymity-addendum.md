...
- User authenticates with identifiers (e.g., email, phone, social login) or linkable credentials (e.g., [EUDI wallet](https://eudi.dev/2.4.0/architecture-and-reference-framework-main/), [W3C VC](https://www.w3.org/TR/vc-data-model-2.0/) without ZK), but the AppView does not expose them to other participants.
...
| Aspect | Pseudonymity | Strong anonymity |
|--------|--------------|------------------|
